...
export function RevenueDataDialog({
  open,
  onClose,
  onSubmit,
  defaultValues,
      ...
      reset(
        defaultValues
          ? {
              ...
              dealValue: defaultValues.dealValue,
              recurringRevenue: defaultValues.recurringRevenue,
      ...
      <div className="fixed inset-y-0 right-0 z-50 flex w-full max-w-lg flex-col bg-background shadow-2xl">
        <div className="flex items-center justify-between border-b px-6 py-4">
          <h2 className="text-lg font-semibold">
            {defaultValues ? "Edit Revenue Entry" : "Add Revenue Entry"}
          </h2>
        ...
        >
          <div className="flex-1 space-y-5 p-6">
            <div className="space-y-2">
              ...
              <Input
                id="source"
                placeholder="e.g. Google Ads, Referral, Organic"
                {...register("source")}
              />
              {errors.source && (
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="number"
                  step="0.01"
                  {...register("recurringRevenue")}
                />
                {errors.recurringRevenue && (
                  <p className="text-xs text-destructive">
                    {errors.recurringRevenue.message}
                  </p>
                )}
              </div>
            </div>
